...
from project.task.cub_vit.models import get_network_generator_vit_sparsyfed, get_network_generator_vit_sparsyfed_no_act, get_tinyvit
...
def dispatch_train(
    ...
    alpha: float | None = cfg.get("task", {}).get("alpha", 1.0)
    sparsity: float | None = cfg.get("task", {}).get("sparsity", 0.0)
